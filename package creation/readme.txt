...
1: pip install -t /path/to/project/quick-view pyexcel pyexcel-xls pyexcel-xlsx textract qpageview

#create the pyz package.
#the .pyz should be placed inside the folder with INSTALL.sh and the shortcut (quick_view_package).
2: python3 -m zipapp /path/to/project/quick_view/ -p /bin/python3 -o ./quick_view_package/quick_view.pyz
